...
impl TryFrom<&str> for Rucksack {
    ...
    fn try_from(s: &str) -> Result<Self, Self::Error> {
        ...
        // Split the line two equal-length strings
...
/// 2u64 with 1 trailing sero, and 'A' wll be stored as 134217728u64 with 27 trailing
/// zeros.
///
...
/// Attempt to conver a single character into an `Item`
